...
class TestPredictFix(unittest.TestCase):
    def test_parse_response_valid(self):
        response = '{"action": "buy", "confidence": 0.8, "percentage": 0.5, "hold_minutes": 30, "reason": "test"}'
    ...
    def test_parse_response_none_percentage(self):
        ...
        response = '{"action": "sell", "confidence": 0.9, "percentage": null, "hold_minutes": 15, "reason": "test"}'
        data = parse_response(response)
    ...
    def test_parse_response_missing_percentage(self):
        ...
        response = '{"action": "hold", "confidence": 0.5, "hold_minutes": 60, "reason": "test"}'
        data = parse_response(response)
        self.assertEqual(data["percentage"], 1.0) # Should default to 1.0
